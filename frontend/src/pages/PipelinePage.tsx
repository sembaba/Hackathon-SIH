      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '1.25rem', flexWrap: 'wrap', gap: '1rem' }}>
        <div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.65rem', flexWrap: 'wrap', marginBottom: '0.4rem' }}>
            <span style={{ backgroundColor: '#0284c7', color: '#ffffff', padding: '4px 10px', borderRadius: '4px', fontSize: '0.78rem', fontWeight: 800, letterSpacing: '0.04em' }}>
              🇮🇳 SMART INDIA HACKATHON
            </span>
            <span style={{ backgroundColor: '#e0f2fe', color: '#0369a1', border: '1px solid #bae6fd', padding: '3px 8px', borderRadius: '4px', fontSize: '0.75rem', fontWeight: 700, display: 'flex', alignItems: 'center', gap: '4px' }}>
              <ShieldCheck size={14} /> ISO 19152 LADM / OGC 3D Cadastre
            </span>
            <span style={{ backgroundColor: '#dcfce7', color: '#15803d', border: '1px solid #bbf7d0', padding: '3px 8px', borderRadius: '4px', fontSize: '0.75rem', fontWeight: 700 }}>
              • Bhu-Aadhaar 14-Digit 3D ULPIN Compliant
            </span>
            <span style={{ backgroundColor: '#f1f5f9', color: '#475569', border: '1px solid #e2e8f0', padding: '3px 8px', borderRadius: '4px', fontSize: '0.75rem', fontWeight: 600 }}>
              MoPR & DoLR SVAMITVA Framework
            </span>
          </div>

          <h1 style={{ fontSize: '1.85rem', fontWeight: 800, color: '#0f172a', margin: '0.3rem 0', letterSpacing: '-0.02em' }}>
            Multi-Sensor 3D Geospatial Ingestion & ULPIN Reconstruction Pipeline
          </h1>
          <p style={{ color: '#475569', fontSize: '0.9rem', margin: 0, maxWidth: '950px', lineHeight: 1.5 }}>
