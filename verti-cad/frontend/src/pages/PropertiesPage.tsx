      ...
      <div className="page-header">
        <div className="page-header-content">
          <div className="page-header-tags">
            <span className="gov-badge-tag info">Bhu-Aadhaar 14-Digit 3D ULPIN</span>
            <span className="gov-badge-tag success">PostGIS PolyhedralSurface Z</span>
          </div>
          <h1 className="page-title">
            <Home size={22} color="#0284c7" />
            <span>Vertical Property Unit Registry</span>
          </h1>
