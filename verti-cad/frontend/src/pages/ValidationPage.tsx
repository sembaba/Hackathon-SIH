      ...
      <div className="page-header">
        <div className="page-header-content">
          <div className="page-header-tags">
            <span className="gov-badge-tag info">Automated Rules Engine</span>
            <span className="gov-badge-tag success">ISO 19152 LADM Compliant</span>
          </div>
          <h1 className="page-title">
            <CheckCircle2 size={22} color="#0284c7" />
            <span>Cadastral Quality &amp; Validation Dashboard</span>
          </h1>
